...
export default function DumpsterAI() {
  ...
  return (
    <>
      <Head>
        <title>Dumpster Rental AI - Dan Talks AI</title>
        <meta name="description" content="AI that answers calls, sends quotes, and books jobs while you're out delivering dumpsters. Transform your dumpster rental business with intelligent automation." />
      ...
      <main className="min-h-screen bg-[#0B1C2E] text-white font-['Inter']">
        ...
        <section className="relative flex flex-col items-center justify-center text-center py-20 px-4 min-h-screen overflow-hidden">
          ...
          >
            ...
            >
              <span className="text-[#F5F7FA]">AI That Works As Hard As Your Dumpster Business.</span>
            </motion.h1>
            ...
            >
              Stop playing phone tag with leads. I build AI systems that answer calls, send quotes, and book jobs while you're out delivering dumpsters.
            </motion.p>
